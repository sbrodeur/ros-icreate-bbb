  ...
  initialized_(false)
{
  ...
  if (publish_debug_topics_)
  {
    ...
    rpy_pose_publisher = nh_.advertise<geometry_msgs::Pose>(
      ros::names::resolve("imu") + "/rpy/pose", 5);
  }
...
void ImuFilterRos::publishFilteredMsg(const ImuMsg::ConstPtr& imu_msg_raw)
{
  ...
  if(publish_debug_topics_)
  {
    ...
    poseMsg.orientation.x = q1;
    poseMsg.orientation.y = q2;
    poseMsg.orientation.z = q3;
    poseMsg.orientation.w = q0;
    rpy_pose_publisher.publish(poseMsg);
